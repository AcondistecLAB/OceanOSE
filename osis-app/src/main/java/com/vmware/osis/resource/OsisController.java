...
public class OsisController {
    ...
    public OsisS3Credential createCredential(
        ...
        logger.info("createCredential,tenantId={},userId={}", tenantId, userId);
    ...
    public OsisTenant createTenant(
        ...
        logger.info("createTenant,request body={}", gson.toJson(osisTenant));
    ...
    public OsisUser createUser(
        ...
        logger.info("create user,tenantId={},request body={}", tenantId, gson.toJson(osisUser));
    ...
    public void deleteCredential(
        ...
        logger.info("deleteCredential, tenantId={}, userId={}, accessKey={}", tenantId, userId, accessKey);
    ...
    public void deleteTenant(
            ...
            @Valid @RequestParam(value = "purge_data", required = false, defaultValue = "true")
                    Boolean purgeData) {
        logger.info("deleteTenant, tenantId={}, purgeData={}", tenantId, purgeData);
    ...
    public void deleteUser(
            ...
            @Valid @RequestParam(value = "purge_data", required = false, defaultValue = "true")
                    Boolean purgeData) {
        logger.info("deleteUser, tenantId={}, userId={}, purgeData={}", tenantId, userId, purgeData);
    ...
    public PageOfOsisBucketMeta getBucketList(
        ...
        logger.info("getBucketList, tenantId={}, offset={}, limit={}", tenantId, offset, limit);
    ...
    public String getConsole(
        ...
        logger.info("getConsole, tenantId={}", tenantId.isPresent()?tenantId.get() : null);
    ...
    public OsisS3Credential getCredential(
            ...
            @PathVariable("accessKey") String accessKey) {
        logger.info("getCredential, tenantId={},userId={},accessKey={}", tenantId.isPresent()?tenantId.get():null,
            userId.isPresent()?userId.get():null, accessKey);
    ...
    public Information getInfo(HttpServletRequest request) {
        ...
        logger.info("getInfo, domain={}", domain);
    ...
    public OsisTenant getTenant(
            ...
            @PathVariable("tenantId") String tenantId) {
        logger.info("getTenant, tenantId={}", tenantId);
    ...
    public OsisUsage getUsage(
        ...
        logger.info("getUsage, tenantId={}, userId={}", tenantId.isPresent() ? tenantId.get() : null,
            userId.isPresent() ? userId.get():null);
    ...
    public OsisUser getUserWithCanonicalID(
        ...
        logger.info("getUserWithCanonicalID, canonicalUserId={}", canonicalUserId);
    ...
    public OsisUser getUserWithId(
            ...
            @PathVariable("userId") String userId) {
        // The userId is actually a userId or canonicalUserId
        logger.info("getUserWithId, tenantId={}, userId={}", tenantId, userId);
        OsisUser user;
        try {
            user = osisService.getUser(tenantId, userId);
        } catch (NotFoundException ex) {
            logger.info("getUserWithId, not found by userId!try with canonicalUserId");
            user = osisService.getUser(userId);
        }
        return user;
    }
    ...
    public Void headTenant(
            ...
            @PathVariable("tenantId") String tenantId) {
        logger.info("headTenant, tenantId={}", tenantId);
    ...
    public void headUser(
            ...
            @PathVariable("userId") String userId) {
        logger.info("headUser, tenantId={}, userId={}", tenantId, userId);
    ...
    public PageOfS3Credentials listCredentials(
            ...
            @Valid @RequestParam(value = "limit", required = false, defaultValue = "100") Long limit) {
        logger.info("listCredentials, tenantId={},userId={},offset={},limit={}", tenantId, userId, offset, limit);
    ...
    public PageOfTenants listTenants(
            ...
            @Valid @RequestParam(value = "limit", required = false, defaultValue = "100") Long limit) {
        logger.info("listTenants, offset={},limit={}", offset, limit);
    ...
    public PageOfUsers listUsers(
            ...
            @Valid @RequestParam(value = "limit", required = false, defaultValue = "100") long limit) {
        logger.info("listUsers, tenantId={},offset={},limit={}", tenantId, offset, limit);
    ...
    public OsisS3Credential updateCredentialStatus(
        ...
        logger.info("updateCredentialStatus,tenantId={},userId={},accessKey={},osisS3Credential={}",
            tenantId, userId, accessKey, gson.toJson(osisS3Credential));
        return osisService.updateCredentialStatus(tenantId, userId, accessKey, osisS3Credential.getActive());
    }
    ...
    public OsisTenant updateTenantStatus(
            ...
            @Valid @RequestBody OsisTenant osisTenant) {
        logger.info("updateTenantStatus,tenantId={},osisTenant={}", tenantId, gson.toJson(osisTenant));
    ...
    public OsisUser updateUserStatus(
        ...
        logger.info("updateUserStatus,request body={}", gson.toJson(osisUser));
    ...
    public PageOfTenants queryTenants(
        ...
        logger.info("queryTenants,offset={},limit={},filter={}", offset, limit, filter);
    ...
    public PageOfS3Credentials queryCredentials(
            ...
            @ApiParam(value = "The conditions to query platform users")
            @Valid @RequestParam(value = "filter", required = false) String filter) {
        logger.info("queryCredentials,offset={},limit={},filter={}", offset, limit, filter);
    ...
    public OsisCaps updateOsisCaps(@RequestBody OsisCaps osisCaps) {
        logger.info("updateOsisCaps,osisCaps={}", gson.toJson(osisCaps));
