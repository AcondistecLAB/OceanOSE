...
public class InformationServices {
   ...
   * @return s3
  */
  @ApiModelProperty(example = "https://s3.huawei.ose.vmware.com", value = "S3 URL of the storage platform")
  public String getS3() {
    return s3;
  }
   ...
   * @return iam
  */
  @ApiModelProperty(example = "https://iam.huawei.ose.vmware.com", value = "IAM URL of the storage platform")
