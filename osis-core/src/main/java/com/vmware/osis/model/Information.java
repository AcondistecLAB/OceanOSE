...
public class Information {
   ...
   * @return platformName
  */
  @ApiModelProperty(example = "huawei", required = true, value = "name of the storage platform")
  ...
  */
   ...
   * @return logoUri
  */
  @ApiModelProperty(example = "https://huawei.ose.vmware.com/static/images/huawei.svg", value = "uri of the platform logo so that OSE can use it on UI")
  @Valid
