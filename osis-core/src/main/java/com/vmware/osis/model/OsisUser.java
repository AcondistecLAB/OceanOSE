...
public class OsisUser {
     ...
     * @return tenantId
     */
    @ApiModelProperty(example = "bb8287a9-874e-46d2-abbd-58278e1ac046", required = true,
        value = "id of the tenant which the user belongs to")
     ...
     * @return cdTenantId
     */
    @ApiModelProperty(example = "40b97e3c-c3b1-4251-b7de-e9637324683f", required = true,
        value = "id of Cloud Director tenant which the user belongs to")
