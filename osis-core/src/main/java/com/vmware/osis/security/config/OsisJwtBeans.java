...
import com.vmware.osis.huawei.security.HuaweiUserDetailsService;
...
public class OsisJwtBeans {
    ...
    @Bean
    protected LoginAuthenticationProvider loginAuthenticationProvider(HuaweiUserDetailsService userService, BCryptPasswordEncoder encoder) {
