...
public class AWSV4Auth {
    ...
    private String prepareCanonicalRequest() {
        ...
        payload = StringUtils.isBlank(payload) ? "" : payload;
    ...
    public Map<String, String> getHeaders() {
        String payloadStr = generateHex(payload);
        awsHeaders.put("x-amz-date", xAmzDate);
        awsHeaders.put("x-amz-content-sha256", payloadStr);
        ...
        if (signature != null) {
            ...
            header.put("x-amz-content-sha256", payloadStr);
            return header;
        } else {
            return null;
        }
    ...
    private String buildAuthorizationString(String strSignature) {
        return HMACAlgorithm + " " + "Credential=" + accessKeyID + "/" + getDate() + "/" + regionName + "/"
            + serviceName + "/" + aws4Request + ", " + "SignedHeaders=" + strSignedHeader + ", " + "Signature="
            + strSignature;
    }
